...
?>
		...
		<table class="widefat" style="width:100% !important;"><thead><tr><th scope="col">
		<img src="<?php echo $llm_url; ?>images/ttweb.png" class="logo">
		<?php _e("Studio TTWeb","link-list-manager");?><br>
		<?php _e("Creation, website promotion","link-list-manager");?><br>
		<?php _e("Development of site design, logos, business cards, etc.","link-list-manager");?><br>
		<?php _e("Development and translation of plugins","link-list-manager");?><br>
		<a href="http://www.TTWeb.ru" target="_blank">http://www.TTWeb.ru</a> | 
		<a href="http://www.zetrider.ru" target="_blank">http://www.ZetRider.ru (free help)</a> 
		<th scope="col" style="border-left:1px #c0c0c0 solid">
		<a href="http://www.facebook.com/zetriderman" target="_blank"><img src="<?php echo $llm_url; ?>images/facebook.png"></a>
		<a href="https://twitter.com/#!/zetrider" target="_blank"><img src="<?php echo $llm_url; ?>images/twitter.png"></a>
		<a href="http://vkontakte.ru/zetrider" target="_blank"><img src="<?php echo $llm_url; ?>images/vkontakte.png"></a><br>
		<b>Donate me:</b><br>
		WMZ    -&nbsp;&nbsp;&nbsp; Z280634834547<br>
		WMR    -&nbsp;&nbsp;&nbsp; R240220810962<br>
		Yandex - 41001637137755<br>
		<small><?php _e("We need a new version of the plugin? thanked the author","link-list-manager"); ?><br><br>
		<b><?php _e("Any ideas? Send me an email: ","link-list-manager"); ?> <a href="mailto:zetrider@bk.ru">zetrider@bk.ru</a></b><br><br>
		</ul>
		</small>
		</th></th></tr></thead></table>
		<br>
		<div style="float:left;"><a href="http://www.zetrider.ru/link-list-manager.html" class="ablock llmradius" target="_blank"><?php _e("Instruction","link-list-manager"); ?></a> <a href="http://wordpress.org/extend/plugins/link-list-manager/" class="ablock llmradius" target="_blank">FAQ / English instruction</a></div>
		<div style="float:right;"><object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" width="468" height="60" align="middle"><param name="movie" value="http://img.sape.ru/bn/sape_002.swf?myID=ZwoFuGbBkC" /><param name="quality" value="high" /><param name="bgcolor" value="#ffffff" /><embed src="http://img.sape.ru/bn/sape_002.swf?myID=ZwoFuGbBkC" quality="high" bgcolor="#ffffff" width="468" height="60" align="middle" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" /></object></div>
